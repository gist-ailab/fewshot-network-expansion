...
def default_argument_parser():
    ...
    parser.add_argument(
        "--gpus", type=str, default='0,1,2,3', help="number of gpus *per machine*"
    )
    parser.add_argument(
        "--exp_name", type=str, default='basic', help="experiment name for the logger*"
    )
